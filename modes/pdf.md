...
12. Generate full HTML from template + personalised content
...
- **Company names**: accent purple colour `hsl(270,70%,45%)`
- **Margins**: 0.6in
...
Use the template in `cv-template.html`. Replace `{{...}}` placeholders with personalised content:
