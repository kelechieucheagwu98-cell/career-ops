...
Interactive mode for when the candidate is filling out an application form in Chrome. Reads what is on screen, loads previous offer context, and generates personalised answers for each form question.
...
- **Notify the candidate**: "The role has changed from [X] to [Y]. Do you want me to re-evaluate or shall I adapt the answers to the new title?"
